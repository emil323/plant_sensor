...
En enkel sensor som forteller deg når planten trenger vann. Ingen app, ingen WiFi - bare et lys som varsler.
...
### 3. Kalibrer tørrvekt
**Viktig:** Gjør dette når jorda er helt tørr!

- Vent til planten er tørr (klar til å vannes)
- Trykk TØR-knappen én gang
...
|------------|-----------|-------------|
| Blinker sakte (3 ganger) | Ikke kalibrert | Trykk TØR-knapp når jorda er tørr |
| Av | Alt OK | Ingenting |
...
**Løsning:** Vent til jorda er tørr, trykk TØR-knapp
